...
class AnimationController {
    ...
    // 公开访问器
    public get cameraZValue() {
        return this.cameraZ
    }
    
    public get viewZoomValue() {
...
class Star {
    ...
    render(p: number, controller: AnimationController) {
        ...
        if (q > 0) {
            ...
            // 将2D屏幕坐标转换为3D空间坐标
            const vx = (this.z - controller.cameraZValue) * screenX / controller.viewZoomValue;
            const vy = (this.z - controller.cameraZValue) * screenY / controller.viewZoomValue;
