...
export default function NewPromoCodePage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await api.promoCodes.create(requestData)
        ...
        <div className="mb-6 flex items-center justify-between">
          <div>
            ...
            <p className="text-muted-foreground" style={{ fontFamily: '"Dream Avenue"' }}>
              Create and distribute promotional codes to customers
            </p>
          </div>
          <Button
            variant="ghost"
          ...
          <form onSubmit={handleSubmit} className="p-6 space-y-6">
            ...
            <div className="space-y-4 border-t pt-6">
              ...
              <Input
                ...
                placeholder="Enter additional email addresses to send promo code notifications. All recipients will receive the code but must be logged in to use it."
                style={{ fontFamily: '"Dream Avenue"' }}
              />
            </div>
