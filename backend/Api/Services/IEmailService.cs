namespace Api.Services
{
    ...
    {
        Task<bool> SendPromoCodeNotificationAsync(string toEmail, string toName, string promoCode, decimal discountValue, string discountType, DateTime? endDate, bool isGuest = false);
        
        /// <summary>
        /// Sends promo code notifications to multiple recipients in parallel
        /// </summary>
        /// <param name="recipients">List of recipients with email, name and guest status</param>
